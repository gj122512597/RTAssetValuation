...
import { List, Empty, Spin, Alert, Tabs, Tag, Button, Drawer } from 'antd';
...
export default function HomePage() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-gray-100">
      ...
      {/* 顶部统计栏（移动端全宽，不再为右侧栏预留 336px） */}
      <div className={isMobile ? 'absolute top-2 left-2 right-2 z-20 space-y-2' : 'absolute top-4 left-4 right-[336px] z-20'}>
        <ProcessFlowBanner />
        <StatBar />
        {error && (
          <div className="mt-2">
      ...
      {isMobile && (
        <>
          <Button
            ...
            style={{ position: 'fixed', right: 16, bottom: 16, zIndex: 30, boxShadow: '0 6px 20px rgba(15,23,42,0.28)' }}
          />
          <Drawer
            title="资产概览"
            placement="right"
